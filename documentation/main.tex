...
\title{	
	...
	{\huge Proiect Curs - First dental website}\\ % The assignment title
...
\lstinputlisting[
	caption=Gmail mail server set-up - se poate observa că datele sensibile nu sunt date explicit ci sunt transmise prin variabile de mediu, % Caption above the listing
...
\begin{figure}[h] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	\includegraphics[width=0.8\columnwidth]{blog_home.png} % Example image
...
\begin{figure}[h] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	\includegraphics[width=0.8\columnwidth]{blog_register.png} % Example image
...
\begin{figure}[h] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	\includegraphics[width=0.8\columnwidth]{blog_login.png} % Example image
...
\begin{figure}[h] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	\includegraphics[width=0.8\columnwidth]{blog_new_post.png} % Example image
...
\begin{figure}[h] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	\includegraphics[width=0.8\columnwidth]{blog_edit_delete.png} % Example image
...
\begin{figure}[h] % [h] forces the figure to be output where it is defined in the code (it suppresses floating)
	\centering
	\includegraphics[width=0.8\columnwidth]{blog_comment.png} % Example image
